...
namespace OpenTK_U
{
    ...
    -0.4f, -0.450f,  0.1f,  // 16 - Frente izquierda
     0.4f, -0.450f,  0.1f,  // 17 - Frente derecha
     0.4f, -0.450f, -0.1f,  // 18 - Atrás derecha
    -0.4f, -0.450f, -0.1f,  // 19 - Atrás izquierda
    ...
    20, 21, 22, 20, 22, 23   // Parte inferior de la base
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            Matrix4 translationToOrigin = Matrix4.CreateTranslation(axisOfRotation); // Traslada al nuevo eje de rotación
            Matrix4 rotation = Matrix4.CreateRotationY(_rotation); // Aplica la rotación en Y
            Matrix4 translationBack = Matrix4.CreateTranslation(-axisOfRotation); // Traslada de vuelta al origen original

            // Combinamos las transformaciones para obtener la rotación alrededor del nuevo eje.
            Matrix4 model = translationToOrigin * rotation * translationBack;
            ...
            // Multiplicamos la matriz de modelo, vista y proyección
